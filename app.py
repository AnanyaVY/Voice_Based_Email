...
email_list = {
    ...
    'd e m o':'kruthin02@gmail.com',
    'archana':'archanabbiradar123@gmail.com',
    'varsha':'varsha.cnraghu@gmail.com',
    'malavika':'malavika@gmail.com',
    'ananya':'varsharaghu9503@gmail.com'
    ...
    if recipient_email:
        ...
        for _ in range(2):
            ...
            if "yes" in confirmation or "send" in confirmation or "compose" in confirmation:
                ...
                talk("Invalid response. Please say 'yes' or 'no'.")
